...
var incompleteTaskHolder=document.getElementById("to-do-form__incomplete-tasks");//ul of #incompleteTasks
var completedTasksHolder=document.getElementById("to-do-form__completed-tasks");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    editButton.className="to-do-form__button_edit";

    deleteButton.className="to-do-form__button_delete";
